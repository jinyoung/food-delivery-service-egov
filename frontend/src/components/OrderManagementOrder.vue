    ...
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                ...
                color="primary"
                text
                @click="openPrepareFood"
            >
                PrepareFood
            </v-btn>
            <v-dialog v-model="prepareFoodDiagram" width="500">
                <PrepareFoodCommand
                    @closeDialog="closePrepareFood"
            ...
            <v-btn
                ...
                color="primary"
                text
                @click="openNotifyRider"
            >
                NotifyRider
            </v-btn>
            <v-dialog v-model="notifyRiderDiagram" width="500">
                <NotifyRiderCommand
                    @closeDialog="closeNotifyRider"
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            prepareFoodDiagram: false,
            notifyRiderDiagram: false,
        }),
	async created() {
        },
        methods: {
            ...
            openPrepareFood() {
                this.prepareFoodDiagram = true;
            },
            closePrepareFood() {
                this.prepareFoodDiagram = false;
            },
            ...
            openNotifyRider() {
                this.notifyRiderDiagram = true;
            },
            closeNotifyRider() {
                this.notifyRiderDiagram = false;
            },
        },
    }
</script>
